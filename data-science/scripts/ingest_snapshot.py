...
def main() -> int:
    ...
    # Use TemporaryDirectory so the download is cleaned up automatically.
    # When the user supplies a zip_path directly, nullcontext is a no-op.
    tmp_dir_ctx: contextlib.AbstractContextManager = (
        tempfile.TemporaryDirectory(prefix="calcutta-analytics-")
