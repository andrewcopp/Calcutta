...
.PHONY: up down reset ops-migrate backend-test backend-integration-test frontend-test ds-test test sqlc-generate
...
backend-integration-test:
	$(ENV) go -C backend test -tags=integration -count=1 -v ./...
