...
type LabRepository interface {
	...
	GetEntryEnriched(ctx context.Context, id string) (*models.LabEntryDetailEnriched, error)
	GetEntryEnrichedByModelAndCalcutta(ctx context.Context, modelName, calcuttaID, startingStateKey string) (*models.LabEntryDetailEnriched, error)
