...
-- Name: predicted_team_values; Type: TABLE; Schema: derived; Owner: -
...
-- Name: TABLE predicted_team_values; Type: COMMENT; Schema: derived; Owner: -
...
-- Name: COLUMN predicted_team_values.expected_points; Type: COMMENT; Schema: derived; Owner: -
...
-- Name: TABLE prediction_batches; Type: COMMENT; Schema: derived; Owner: -
...
-- Name: COLUMN prediction_batches.probability_source_key; Type: COMMENT; Schema: derived; Owner: -
...
-- Name: COLUMN prediction_batches.game_outcome_spec_json; Type: COMMENT; Schema: derived; Owner: -
...
-- Name: predicted_team_values predicted_team_values_pkey; Type: CONSTRAINT; Schema: derived; Owner: -

ALTER TABLE ONLY derived.predicted_team_values
    ADD CONSTRAINT predicted_team_values_pkey PRIMARY KEY (id);


-- Name: prediction_batches prediction_batches_pkey; Type: CONSTRAINT; Schema: derived; Owner: -

ALTER TABLE ONLY derived.prediction_batches
    ADD CONSTRAINT prediction_batches_pkey PRIMARY KEY (id);
...
-- Name: idx_predicted_team_values_batch_id; Type: INDEX; Schema: derived; Owner: -
...
-- Name: idx_predicted_team_values_team_id; Type: INDEX; Schema: derived; Owner: -
...
-- Name: idx_predicted_team_values_tournament_id; Type: INDEX; Schema: derived; Owner: -
...
-- Name: idx_prediction_batches_created_at; Type: INDEX; Schema: derived; Owner: -
...
-- Name: idx_prediction_batches_tournament_id; Type: INDEX; Schema: derived; Owner: -
...
-- Name: predicted_team_values predicted_team_values_prediction_batch_id_fkey; Type: FK CONSTRAINT; Schema: derived; Owner: -

ALTER TABLE ONLY derived.predicted_team_values
    ADD CONSTRAINT predicted_team_values_prediction_batch_id_fkey FOREIGN KEY (prediction_batch_id) REFERENCES derived.prediction_batches(id);


-- Name: predicted_team_values predicted_team_values_team_id_fkey; Type: FK CONSTRAINT; Schema: derived; Owner: -

ALTER TABLE ONLY derived.predicted_team_values
    ADD CONSTRAINT predicted_team_values_team_id_fkey FOREIGN KEY (team_id) REFERENCES core.teams(id);


-- Name: predicted_team_values predicted_team_values_tournament_id_fkey; Type: FK CONSTRAINT; Schema: derived; Owner: -

ALTER TABLE ONLY derived.predicted_team_values
    ADD CONSTRAINT predicted_team_values_tournament_id_fkey FOREIGN KEY (tournament_id) REFERENCES core.tournaments(id);


-- Name: prediction_batches prediction_batches_tournament_id_fkey; Type: FK CONSTRAINT; Schema: derived; Owner: -

ALTER TABLE ONLY derived.prediction_batches
    ADD CONSTRAINT prediction_batches_tournament_id_fkey FOREIGN KEY (tournament_id) REFERENCES core.tournaments(id);
