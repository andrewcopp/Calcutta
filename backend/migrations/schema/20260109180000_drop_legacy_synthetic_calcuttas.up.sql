-- Phase A5 (minimal): remove legacy synthetic calcuttas + candidates and synthetic_calcutta_id from simulation_runs.
...
DROP INDEX IF EXISTS uq_derived_simulation_runs_batch_synthetic_calcutta;
DROP INDEX IF EXISTS idx_derived_simulation_runs_synthetic_calcutta_id;

ALTER TABLE IF EXISTS derived.simulation_runs
    DROP COLUMN IF EXISTS synthetic_calcutta_id;
