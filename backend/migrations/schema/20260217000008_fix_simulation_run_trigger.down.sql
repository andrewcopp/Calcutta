-- Restore the original trigger function that references dropped columns.
-- Only valid if market_share_run_id, strategy_generation_run_id, and optimizer_key
-- have been restored by 20260217000007 down.
