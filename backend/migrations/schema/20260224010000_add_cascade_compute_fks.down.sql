...
ALTER TABLE compute.predicted_team_values
  ...
  FOREIGN KEY (prediction_batch_id) REFERENCES compute.prediction_batches(id);
...
ALTER TABLE compute.simulated_teams
  ...
  FOREIGN KEY (simulated_tournament_id) REFERENCES compute.simulated_tournaments(id);
