    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex-shrink-0 w-20 text-center">
          ...
          <p className={cn('text-sm font-semibold', getPayoutColorClass(entry.avg_mean_payout))}>
        ...
        <div className="flex-shrink-0 w-16 text-center">
          ...
          <p className="text-sm font-medium text-gray-700">{formatPct(entry.avg_p_top1)}</p>
        </div>
